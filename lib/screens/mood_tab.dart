  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (userId != null && userId.isNotEmpty) {
        await context.read<MoodProvider>().init(userId);
      }
    });
  }
                  ...
                  (mood) => GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(color: mood.$3.withValues(alpha: 0.5)),
                      ),
                      child: Row(
                  ...
                  try {
                    ...
                    if (dialogContext.mounted) {
                      ScaffoldMessenger.of(dialogContext).showSnackBar(
                        SnackBar(content: Text('Unable to log mood: $e')),
                      );
                    }
                  }
                },
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: AppColors.lavender.withValues(alpha: 0.2), blurRadius: 15)
        ],
      ),
      child: Row(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                if (entry.isPeriodDay)
                  const Text('Period day',
                      style:
                          TextStyle(color: AppColors.deepPink, fontSize: 12)),
              ],
            ),
          ),
          IconButton(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: AppColors.lavender.withValues(alpha: 0.15), blurRadius: 12)
        ],
      ),
      child: TableCalendar(
